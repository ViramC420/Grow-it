...
# Soph use "pico4"
# issa use "pico5"
device_id = " "  # change for each pico.(1,2,3...)

user_id = " " #userId for pico owner
...
# DigitalOcean/Flask server IP
SERVER_URL = "http://128.199.0.224:5003/update_data"
